  ...
  return (
    <div className="w-full flex justify-center overflow-x-hidden">
      <div
        ...
        style={{
          backgroundImage: 'url(/assets/corner-left.png)',
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/assets/tile-top-left.png)',
          backgroundSize: 'auto 100%',
        }}
      />
      <div
        ...
        style={{
          backgroundImage: 'url(/assets/top-bg2.png)',
      ...
      <div
        className="w-full mb-ext:block hidden bg-right  bg-cover h-[56px]"
        style={{
          backgroundImage: 'url(/assets/tile-top-right.png)',
          backgroundSize: 'auto 100%',
        }}
      />
      <div
        ...
        style={{
          backgroundImage: 'url(/assets/corner-right.png)',
          backgroundSize: 'auto 100%',
        }}
      />
    </div>
